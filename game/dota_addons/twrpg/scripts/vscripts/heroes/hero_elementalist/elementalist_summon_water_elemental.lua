...
function SummonWaterElemental( keys )
	...
	-- Get the abilities
	local ability_1 = caster.water_elemental:GetAbilityByIndex(1)
	local ability_2 = caster.water_elemental:GetAbilityByIndex(2)
	local ability_3 = caster.water_elemental:GetAbilityByIndex(3)
